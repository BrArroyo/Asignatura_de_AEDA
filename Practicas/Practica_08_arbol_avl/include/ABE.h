...
/**
 * @brief Método para insertar una clave en el árbol binario equlibrado
 */
template<class Key>
...
/**
 * @brief Método para buscar una clave en el árbol binario equilibrado
 */
template<class Key>
...
/**
 * @brief Método para eliminar una clave en el árbol binario equilibrado
 */
template<class Key>
