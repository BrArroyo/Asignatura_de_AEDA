 ...
 * @return false 
 */
bool Grid::SetInitCells(int row, int col, char type) {
  ...
  switch ((*(grid_ + row) + col)->GetState()) {
    case 'H':
      std::cout << "la celula en esa posición esta en estado huevo" << std::endl;  
      return false;
      break;
    case 'L':
      std::cout << "la celula en esa posición esta en estado larva" << std::endl;  
      return false;
      break;
    case 'P':
      std::cout << "la celula en esa posición esta en estado pupa" << std::endl;  
      return false;
      break;
    case 'A':
      std::cout << "la celula en esa posición esta en estado adulta" << std::endl;  
      return false;
      break;  
    default:
      break;
  ...
  switch (type) {
    case 'H':
      (*(grid_ + row) + col)->SetState(new StateEgg);
      break;
    case 'L':
      (*(grid_ + row) + col)->SetState(new StateLarva);
      break;
    case 'P':
      (*(grid_ + row) + col)->SetState(new StatePupa);
      break;
    case 'A':
      (*(grid_ + row) + col)->SetState(new StateAdult);
      break;  
    default:
      break;
  }
