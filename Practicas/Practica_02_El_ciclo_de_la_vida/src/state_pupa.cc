/**
 * Archivo state_pupa.cc: Clase StatePupa.
 * 
 ...
 * @date 12/03/2022
 * 
 * @brief Desarrollo de las funciones de la clase StatePupa 
 * 
...
State* StatePupa::NextState() {
  if (larva_neighbors_ > dead_neighbors_ || larva_neighbors_ > egg_neighbors_ || larva_neighbors_ > pupa_neighbors_ ||  larva_neighbors_ > adult_neighbors_) {
