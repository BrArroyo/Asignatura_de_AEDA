/**
 * Archivo grid_with_open_border.h: Clase GridWithOpenBorder.
 * 
...
#ifndef LIFE_CYCLE_GRID_WITH_OPEN_BORDER_H_
#define LIFE_CYCLE_GRID_WITH_OPEN_BORDER_H_
...
#endif  // LIFE_CYCLE_GRID_WITH_OPEN_BORDER_H_