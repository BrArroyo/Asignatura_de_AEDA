/**
 * Archivo grid_with_reflective_border.cc: Clase GridWithReflectiveBorder.
 * 
 ...
 * @date 20/02/2022
 * 
 * @brief Desarrollo de las funciones de la clase GridWithReflectiveBorder 
 * 
 * La función de la clase GridWithReflectiveBorder es es representar una rejilla con borde reflective
 ...
 * @return const Cell& 
 */
const Cell& GridWithReflectiveBorder::GetCell(int row, int col) {
  return *(*(grid_ + row) + col);
}


Cell& GridWithReflectiveBorder::GetCell(int row, int col) const {
...
bool GridWithReflectiveBorder::SetInitPosition(int row, int col) {
 ...
 * @return std::ostream& 
 */
std::ostream& GridWithReflectiveBorder::operator>>(std::ostream& os) {
  os << "▄";
